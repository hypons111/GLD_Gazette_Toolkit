...
//added isOversetedGNNumberTextFrame() & splitOversetedGNNumberTextFrame()
...
//added isOversetedGNNumberTextFrame()
...
function isOversetedGNNumberTextFrame() {
...
function isChapter622(textFrames) {
    try {
...
function isMultiTextFrame(page) {
    for(var y = 0; y < page.rectangles.length; y ++) {
        if(!page.rectangles[y].parent === false) {
            automatation = false
            break
        }
    }
