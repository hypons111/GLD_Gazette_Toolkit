...
makeText(document.masterSpreads.item(1), [10, 15, 30, 165], 類型[type] + " 32 Pages " + jobName, "Taipei Sans TC Beta", 20, "Blue", Justification.leftAlign, VerticalJustification.TOP_ALIGN, 0, false);
//  16 page section information
makeText(document.masterSpreads.item(2), [10, 15, 30, 165], 類型[type] + " 16 Pages " + jobName, "Taipei Sans TC Beta", 20, "Blue", Justification.leftAlign, VerticalJustification.TOP_ALIGN, 0, false);
//  12 page section information
makeText(document.masterSpreads.item(3), [10, 15, 30, 165], 類型[type] + " 12 Pages " + jobName, "Taipei Sans TC Beta", 20, "Blue", Justification.leftAlign, VerticalJustification.TOP_ALIGN, 0, false);
//  8 page section information
makeText(document.masterSpreads.item(4), [10, 15, 30, 165], 類型[type] + " 8 Pages " + jobName, "Taipei Sans TC Beta", 20, "Blue", Justification.leftAlign, VerticalJustification.TOP_ALIGN, 0, false);
//  4 page section information
makeText(document.masterSpreads.item(5), [10, 15, 30, 165], 類型[type] + " 4 Pages " + jobName, "Taipei Sans TC Beta", 20, "Blue", Justification.leftAlign, VerticalJustification.TOP_ALIGN, 0, false);
...
// for test
makeText(document.pages.item(0), [275.411, 43.6, 287.086, 200], "" + totalPage, "Times New Roman", 13, "Red",  Justification.centerAlign, VerticalJustification.BOTTOM_ALIGN, 0, false);
makeText(document.pages.item(0), [275.411, 72.2, 287.086, 150], "" + pageCounter, "Times New Roman", 13, "Red",  Justification.centerAlign, VerticalJustification.BOTTOM_ALIGN, 0, false);
...
if(startPage1-1 !== endContents && startPage1>0){
    Blank1=startPage1-1;
    app.findGrepPreferences.findWhat="\r"+Blank1+"$";
...
if(startPage2-1 !== endPage1 && startPage2){
    Blank2=startPage2-1;
    app.findGrepPreferences.findWhat="\r"+Blank2+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage3-1 !== endPage2 && startPage3){
    Blank3=startPage3-1;
    app.findGrepPreferences.findWhat="\r"+Blank3+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage4-1 !== endPage3 && startPage4){
    Blank4=startPage4-1;
    app.findGrepPreferences.findWhat="\r"+Blank4+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage5-1 !== endPage4 && startPage5){
    Blank5=startPage5-1;
    app.findGrepPreferences.findWhat="\r"+Blank5+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage6-1 !== endPage5 && startPage6){
    Blank6=startPage6-1;
    app.findGrepPreferences.findWhat="\r"+Blank6+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage7-1 !== endPage6 && startPage7){
    Blank7=startPage7-1;
    app.findGrepPreferences.findWhat="\r"+Blank7+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage8-1 !== endPage7 && startPage8){
    Blank8=startPage8-1;
    app.findGrepPreferences.findWhat="\r"+Blank8+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage9-1 !== endPage8 && startPage9){
    Blank9=startPage9-1;
    app.findGrepPreferences.findWhat="\r"+Blank9+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage10-1 !== endPage9 && startPage10){
    ...
    app.findGrepPreferences.findWhat="\r"+Blank10+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage11-1 !== endPage10 && startPage11){
    ...
    app.findGrepPreferences.findWhat="\r"+Blank11+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage12-1 !== endPage11 && startPage12){
    ...
    app.findGrepPreferences.findWhat="\r"+Blank12+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage13-1 !== endPage12 && startPage13){
    ...
    app.findGrepPreferences.findWhat="\r"+Blank13+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage14-1 !== endPage13 && startPage14){
    ...
    app.findGrepPreferences.findWhat="\r"+Blank14+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
if(startPage15-1 !== endPage14 && startPage15){
    ...
    app.findGrepPreferences.findWhat="\r"+Blank15+"$";
    app.changeGrepPreferences.changeTo="Blank";
    app.activeDocument.changeGrep();
    app.changeGrepPreferences = NothingEnum.nothing;
}
