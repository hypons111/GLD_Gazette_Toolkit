...
if (sectionCounter > 136){
    pbTable = document.pages.item(0).textFrames.add();    
    for(pageNumber=startPage1; pageNumber<=pageCounter; pageNumber=pageNumber-1){
        pbTable.texts.item(0).contents = pageNumber+"\r";
    }
}
