...
if (類型[type] == "特報"  &&  nop4>0 && totalPage<5){
    makeText(document.pages.item(0), [263.736, 43.6, 275.411, 200 ], "→　Flat Work \\\\ gaz sm33_4pp pf Logo single", "Times New Roman", 13, "Red",  Justification.centerAlign, VerticalJustification.BOTTOM_ALIGN, 0, false);
}else if (類型[type]=="Sup 1 + Index A" || 類型[type]=="Sup 2 + Index B" || 類型[type]=="Sup 3 + Index C"  &&  nop4>0 && totalPage<5){
    makeText(document.pages.item(0), [263.736, 43.6, 275.411, 200 ], "→　Flat Work \\\\ gaz sm33_4pp pf W/B single", "Times New Roman", 13, "Red",  Justification.centerAlign, VerticalJustification.BOTTOM_ALIGN, 0, false);
}
...
// Make text frame
function makeText(myPage, myBounds, myString, myFontName, myPointSize, myColor, myJustification, myVerticalJustification, myTransfrom, sectionCounter, myFitToContent){
