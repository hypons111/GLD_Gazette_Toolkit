...
mP32TF.texts.item(0).contents = 類型[type] + " 32 Pages";
...
mP16TF.texts.item(0).pointSize = 27;
...
mP12TF.texts.item(0).pointSize = 27;
...
mP8TF.texts.item(0).pointSize = 27;
...
mP4TF.texts.item(0).pointSize = 27;
...
function makeDialog()
{
    ...
    dialog.panel.add('statictext',  [10,55,90,80], "Job Number："); 
    dialog.jobNumber = dialog.panel.add('edittext', [100,50,215,75], "");
    dialog.jobNumber.onChange = jobNumberValidator;
...
if (totalPage > 224){
    makeText(document.pages.item(0), [40, 70, 70, 120], "Pefect", "Times New Roman", 25, Justification.centerAlign, false, 0);
}else{
    makeText(document.pages.item(0), [40, 70, 70, 120], "Saddle", "Times New Roman", 25, Justification.centerAlign, false, 0);
}
...
function jobNumberValidator(){
    jobNumberValidator(dialog.jobNumber, placementINFO.pgCount, "Job Number");
}
