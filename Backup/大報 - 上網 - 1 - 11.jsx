...
for(var x = 0; x < activeDocument.pages.length; x ++) {
    ...
    groupMultiTextFrame(activeDocument.pages[x])
...
function groupMultiTextFrame(page) {
            ...
            try{
                ...
                || page.textFrames[y].contents.toString().slice(1, 2) === "第") {
                    for(var z = 0; z < graphics.length; z ++) {
                        ...
                        && page.textFrames.length === 1
                        && page.groups.length === 0) {
                            page.groups.add(page.pageItems)
                        } else if(graphics[z].parent.geometricBounds[0] > page.textFrames[y].geometricBounds[0] 
                        && page.textFrames.length >= 1) {
                            activeDocument.groups.add([page.textFrames[y], graphics[z].parent])
                        }
                    }
                }
            } catch(e) {}
