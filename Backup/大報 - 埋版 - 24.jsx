    ...
    if(insertHeader(getHeader(version))) {
        for (var x = 0; x < orderList.length; x ++) {
            try{
                ...
                if(isThreadTextFrame(activeDocument) && isThreadingGNNumberTextFrame(activeDocument)
                 && activeDocument.name.toString()[0] + activeDocument.name.toString()[1] != "MA") {
...
function isThreadingGNNumberTextFrame(document) {
