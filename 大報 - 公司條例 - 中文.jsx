...
///////////    Version 9    ///////////    2021-10-6    ///////////
//added pdf auto move left 1p8 to correct corrdinate
...
function moveLeftSwitch() {
    if(sectionNumbers[type] == "751(3)" ||
     sectionNumbers[type] == "798(2)" ||
     sectionNumbers[type] == "744(3)" ||
     sectionNumbers[type] == "745(2)(b)" ||
     sectionNumbers[type] == "797(2)(b)") {
        return true
    } else {    
        return false
    }
...
if(moveUpSwitch() === true) {
    moveUp()
}
if(moveDownSwitch() === true) {
    moveDown()
}


function moveUpSwitch() {
    if(sectionNumbers[type] == "744(3)") {
        return true
    } else {    
        return false
    }
...
function moveUp() {
    try {
        ...
        var newBottom = image.geometricBounds[2] - image.geometricBounds[0] - 77
            image.geometricBounds = ["-77", image.geometricBounds[1], newBottom, image.geometricBounds[3]];
    } catch(e) {}
}


function moveDownSwitch() {
    if(sectionNumbers[type] == "746(2)") {
        return true
    } else {    
        return false
    }
...
function moveDown() {
    try {
        var image = activeDocument.pages[0].textFrames[0].rectangles[0].allGraphics[0]
        var newBottom = image.geometricBounds[2] - image.geometricBounds[0] - 51
            image.geometricBounds = ["-51", image.geometricBounds[1], newBottom, image.geometricBounds[3]];
    } catch(e) {}
}
*/